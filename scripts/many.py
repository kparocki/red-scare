...
from util.dag import has_cycle
import os


def many_nx(s: str, t: str, adj_list: dict[str, set[str]], red: set[str], timeout_sec: int = 5) -> int | None:
    ...
    try:
        ...
        return many_exhaustive(s, t, G, red, timeout_sec)
...
def many_exhaustive(s: str, t: str, G: nx.DiGraph, red: set[str], timeout_sec: int = 5) -> int | None:
    try:
